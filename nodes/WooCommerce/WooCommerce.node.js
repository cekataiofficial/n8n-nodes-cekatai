	...
	constructor() {
		...
		this.methods = {
			loadOptions: {
				async getCategories() {
					const returnData = [];
					const categories = await GenericFunctions_1.woocommerceApiRequestAllItems.call(
						this,
						'GET',
						'/products/categories',
						{},
				...
				async getTags() {
					const returnData = [];
					const tags = await GenericFunctions_1.woocommerceApiRequestAllItems.call(
						this,
						'GET',
						'/products/tags',
						{},
		...
		for (let i = 0; i < length; i++) {
			if (resource === 'customer') {
				if (operation === 'create') {
					...
					responseData = await GenericFunctions_1.woocommerceApiRequest.call(
						this,
						'POST',
						'/customers',
						body,
					...
					if (returnAll) {
						responseData = await GenericFunctions_1.woocommerceApiRequestAllItems.call(
							this,
							'GET',
							'/customers',
							{},
