		...
		this.webhookMethods = {
			default: {
				async checkExists() {
					...
					const webhooks = await GenericFunctions_1.woocommerceApiRequest.call(
						this,
						'GET',
						endpoint,
						{},
				...
				async create() {
					...
					const { id } = await GenericFunctions_1.woocommerceApiRequest.call(
						this,
						'POST',
						endpoint,
						body,
				...
				async delete() {
					...
					try {
						await GenericFunctions_1.woocommerceApiRequest.call(
							this,
							'DELETE',
							endpoint,
							{},
