	...
	webhookMethods = {
		default: {
			async checkExists(this: ITriggerFunctions) {
                ...
                const response = await cekatApiRequest.call(this, 'GET', '/business_workflows/webhooks', {}, {
                    webhookUrl,
					inboxId,
                });
			...
			async create(this: ITriggerFunctions) {
				...
				await cekatApiRequest.call(this, 'POST', '/business_workflows/webhooks/subscribe', {
					events,
					webhookUrl,
					inboxId,
				});
			...
			async delete(this: ITriggerFunctions) {
				...
				await cekatApiRequest.call(this, 'POST', '/business_workflows/webhooks/unsubscribe', {
					events,
					webhookUrl,
					inboxId,
				});
