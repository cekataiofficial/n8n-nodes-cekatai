...
export async function getTransactions(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	try {
		...
		throw new NodeOperationError(this.getNode(), `Error getting dataflow transactions: ${error.message}`);
	}
}
