...
exports.sendErrorPostReceive =
	exports.cleanPhoneNumber =
	exports.sanitizePhoneNumber =
	exports.componentsRequest =
	exports.templateInfo =
	exports.mediaUploadFromItem =
	exports.setType =
	exports.addTemplateComponents =
		void 0;
...
async function cleanPhoneNumber(requestOptions) {
	const phoneNumber = (0, exports.sanitizePhoneNumber)(
		this.getNodeParameter('recipientPhoneNumber'),
	);
	if (!requestOptions.body) {
		requestOptions.body = {};
	}
